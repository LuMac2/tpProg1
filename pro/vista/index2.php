...
<html lang="es">
  ...
  <ul class='nav'>
     <h2 class="color">Se trata de un sistema de notas de “tareas pendientes”</h2>
  	...
  	<center>
         ...
         <div class="col-sm-4 col-md-4 col-lg-3"><br>
			...
			<div class="form-group">
				<input type="text" name="nombre" id="form-nombre" autofocus required placeholder="Ingresa tu nombre">
		 	</div>
		 	<div class="form-group">
				<input type="email" name="email" id="form-email" required placeholder="Ingresa tu dirección de e-mail">
		 	</div>
		 	<div class="form-group">
		 	<input type="password" name="pass" id="form-password" required placeholder="Ingresa tu contraseña">
		 	</div>
			<div class="form-group">
			<input type="password" name="passconfirm"  id="form-passconfirm" required placeholder="Confirma tu contraseña">
			</div>
